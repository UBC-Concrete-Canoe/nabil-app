...
void OcctWidget::paintEvent(QPaintEvent *e)
{
...
void OcctWidget::mousePressEvent(QMouseEvent *e)
{
    if (m_controller)
...
void OcctWidget::mouseReleaseEvent(QMouseEvent *e)
{
    if (m_controller)
        m_controller->onMouseEvent(e);
}

void OcctWidget::wheelEvent(QWheelEvent *e)
{
    if (m_controller)
        m_controller->onWheelEvent(e);
}

void OcctWidget::keyPressEvent(QKeyEvent *e)
{
    if (m_controller)
